...
- [CQR-59](https://linear.app/cqr/issue/CQR-59)
  ...
  brewing, and 2D/3D visual parity with the CQR-53 environments. **Status:** spec authored
  in-cycle (`requirements.md` + `plan.md` + `tasks.md`); ready to implement. Delivered as
  **one combined spec**, phased A (city expansion) → B (Apothecary).
